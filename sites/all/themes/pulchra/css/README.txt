...
To use these stylesheets, rename the files and pulchra with the name of your theme.
...
pulchra-alpha-default-narrow.css  
...
pulchra-alpha-default-normal.css
...
pulchra-alpha-default-wide.css
